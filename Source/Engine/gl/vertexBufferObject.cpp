...
void* CVertexBufferObject::MapSubBufferToMemory(int iUsageHint, uint32 uiOffset, uint32 uiLength)
{
	if(!bDataUploaded)return NULL;
...
void CVertexBufferObject::AddData(void* ptrData, uint32 uiDataSize)
{
...
uint32 CVertexBufferObject::GetBufferID()
{
	return uiBuffer;
}
